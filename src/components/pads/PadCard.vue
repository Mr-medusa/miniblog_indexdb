    ...
    export default {
        ...
        methods: {
            ...
            deleteAll(){
                if(this.batchBasket.size>0){
                    ...
                    for (var j = 0; j < cards.length; j++) {
                        ...
                        /*** Persistence Data ***/
                        PadsService.deleteCard(cards[j].id);
                        /*** Persistence Data ***/
                    }
                    if(results.length){
                    ...
                    /*** Persistence Data ***/
                    PadsService.put(EventHub,{successful:"删除pad成功!",unsuccessful:"删除pad失败!"});
                    /*** Persistence Data ***/
            ...
            updatePadNameAlertOK(){
                ...
                /*** Persistence Data ***/
                PadsService.put(EventHub,{successful:"修改pad成功!",unsuccessful:"修改pad失败!"});
                /*** Persistence Data ***/
            },
            ...
            deletePadAlertOK() {
                ...
                /*** Persistence Data ***/
                PadsService.deleteCard(this.operatorCard.id);
                PadsService.put(EventHub,{successful:"删除pad成功!",unsuccessful:"删除pad失败!"});
                /*** Persistence Data ***/
            ...
            moveToOtherFolderOK(parent){
                ...
                /*** Persistence Data ***/
                PadsService.put(EventHub,{successful:"移动成功!",unsuccessful:"移动失败!"});
                /*** Persistence Data ***/
