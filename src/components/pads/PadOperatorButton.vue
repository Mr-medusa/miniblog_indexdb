    ...
    <div class="pads-secondary-nav" v-bind:style="{zIndex:isShowCompleted}">
        ...
        <transition>
            <div class="operator-btn type-area" v-show="isShow">
                ...
                <div class="btn-group">
                    <button class="btn hvr-wobble-top" v-bind:class="{selectAllCss:selectState}" @click="operatorAll">批量操作</button>
                    <button class="btn" v-bind:class="{'hvr-wobble-top':selectState,'disabled-btn':!selectState}" :disabled="!selectState" @click="selectAllOfBoxes()">全选</button>
