    ...
    <div class="edit_blog">
        ...
        <div class="more-info">
            ...
            <div class="date">
                ...
                <span>{{readOrEdit.blog.updateTime | dateToLocalTime}}</span>
            </div>
    ...
    export default {
        ...
        mounted(){
            ...
            if(tags){
                for (let i = 0; i < tags.length; i++) {
                    if(tags[i].trim())
                        this.oldTagsArr.push(tags[i].trim());
                }
            }
        },
        data(){
        ...
        methods:{
            ...
            saveBlog(){
                ...
                /*****++++++++++++++++++++++ View START ++++++++++++++++++++++********/
                this.readOrEdit.blog.updateTime = new Date();
                ...
                /******** BlogContent ********/
                var blogContent = Object.assign({},this.readOrEdit.blog);
                var persisBlog = {
                    id:blogContent.id,
                    title:blogContent.title,
                    author:blogContent.author,
                    updateTime:blogContent.updateTime,
                    tags:blogContent.tags,
                    isShowBanner:blogContent.isShowBanner,
                };
                blogContent.tags = blogContent.tags.join(" ");
                /******** BlogContent ********/

                BlogService.putBlogAndTags(persisBlog,blogContent,EventHub.blogTagMap,{successful:"保存成功!",unsuccessful:"保存Blog失败!"});
